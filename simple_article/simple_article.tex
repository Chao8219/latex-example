...
\usepackage{booktabs}
\usepackage{amsmath}
\usepackage[nottoc]{tocbibind} % includes ref in toc
...
\newglossaryentry{curly letter X}{
	name={$\mathcal{X}_{0}$},
	description={The curly letter $X$, 
	presenting a set}
}
\newglossaryentry{curly letter Y}{
	name={$\mathcal{Y}_{0}$},
	description={The curly letter $Y$, 
	presenting a set}
}
\makeglossaries
...
\bibliography{simple_article_bib}
